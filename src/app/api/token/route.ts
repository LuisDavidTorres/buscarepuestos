    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Has solicitado restablecer tu contraseña para tu cuenta. Para continuar, haz clic en el siguiente enlace:</p>
          <p><a href="http://localhost:3000/restablecer-contrasena/${token.token}">Restablecer Contraseña</a></p>
          <p>Este enlace caducará en 4 horas.</p>
          <p>Si no has solicitado restablecer tu contraseña, ignora este correo electrónico. Tu contraseña actual seguirá siendo la misma.</p>
        </div>
        <div class="footer">
          <p>Atentamente,</p>
