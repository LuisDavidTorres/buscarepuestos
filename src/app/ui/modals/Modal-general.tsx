          ...
          <div className="rounded-md bg-white p-4 xl:h-2/5 xl:w-2/5 w-11/12">
            ...
            <div className="flex text-center flex-col space-y-14">
              ...
              {messageModalGeneral.id === 1 && (
                <section>
                  <button onClick={onClick} className="p-2 rounded-md text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium text-sm px-5 py-2.5 text-center me-2 mb-2">
                    Obtener mas clicks
                  </button>
                </section>
              )}
