...
export function ToEnter() {
  ...
  return (
    <>
      ...
      >
        <span className="w-full sm:w-52 relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-custom-green rounded-md group-hover:bg-opacity-0">
